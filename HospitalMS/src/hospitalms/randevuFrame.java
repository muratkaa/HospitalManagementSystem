 ...
 * @author murat
 */
public class randevuFrame extends javax.swing.JFrame {

    /**
     * Creates new form randevuFrame
     */
    public randevuFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel14.setText("HASTA ADI SOYADI");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "HASTA ADI SOYADI", "BÖLÜM", "ŞİKAYET", "TARİH"
            }
        ));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        ...
                        .addGap(88, 88, 88)
                        .addComponent(adpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(125, 125, 125))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (adpanel.getText().equals("")) {
            for (int i = 0; i < Data.randevuArrayList.size(); i++) {

                tblModel.insertRow(tblModel.getRowCount(), new Object[]{Data.randevuArrayList.get(i).getAd(), Data.randevuArrayList.get(i).getBolum(), Data.randevuArrayList.get(i).getSikayet(), Data.randevuArrayList.get(i).getTarih()});

            };
        } else {

            for (int i = 0; i < Data.randevuArrayList.size(); i++) {
                if(adpanel.getText().equals(Data.randevuArrayList.get(i).getAd())){
                       tblModel.insertRow(tblModel.getRowCount(), new Object[]{Data.randevuArrayList.get(i).getAd(), Data.randevuArrayList.get(i).getBolum(), Data.randevuArrayList.get(i).getSikayet(), Data.randevuArrayList.get(i).getTarih()});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(randevuFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
